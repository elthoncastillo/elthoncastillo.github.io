...
//    public string currentText { get { return _currentText; } } //gets the current dissplay text
//    private string _currentText = ""; 

//    private string preText; //prestuff build
//    private string targetText; //reference from SistemaDeDialogo

//    private int charactersPerFrame = 1; //only one characther per frame allowed
//    [Range(1f, 60f)] //Unity attribuit that allow us to modify a certain range within the inspector
...
//        buildProcess = SistemaDeDialogo.instance.StartCoroutine(Construction());
//    }
...
//        if (isConstructing)
//        {
//            SistemaDeDialogo.instance.StopCoroutine(buildProcess);
//        }
//        buildProcess = null;
//    }
